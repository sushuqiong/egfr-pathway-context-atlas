...
fig3 <- (pA / pB) | (C1 / pC2)
fig3 <- pA / pB / (C1 | pC2)
ggsave(file.path(F,"Fig3_comparability_checks.png"), fig3, width=W, height=11.5, dpi=300, limitsize=FALSE)
ggsave(file.path(F,"Fig3_comparability_checks.pdf"), fig3, width=W, height=11.5)
