...
**Figure 2. Technical validation.** (A) Documented exclusions, flags and non-testable comparisons (log scale). (B) The single-cell comparison design actually used, by test type. (C) The complete estimates layer: all per-cohort standardized effects, including non-significant results.
